...
import com.ybs.common.util.AdrressIpUtils;
import com.ybs.pojo.AccessLog;
...
public class AccessLogInterceptor implements HandlerInterceptor {
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object o, Exception e) throws Exception {
        ...
        //请求开始时间
        long rBeginTime = Long.parseLong(request.getAttribute(LOGGER_SEND_TIME).toString());


        //设置请求时间差
        accessLog.setDuration(Integer.valueOf((currentTime - rBeginTime) + ""));
